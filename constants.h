...
CHARCONSTANT(GOWHATSAPP_MULTIMESSAGE_CONVERSION_OPTION, "multimessage-conversion");
...
/*
 * Choices for GOWHATSAPP_MULTIMESSAGE_CONVERSION_OPTION.
 */
CHARCONSTANT(GOWHATSAPP_MULTIMESSAGE_CONVERSION_CHOICE_OFF, "off");
CHARCONSTANT(GOWHATSAPP_MULTIMESSAGE_CONVERSION_CHOICE_PIPE, "pipe");
CHARCONSTANT(GOWHATSAPP_MULTIMESSAGE_CONVERSION_CHOICE_MULTIMESSAGE, "multimessage");
