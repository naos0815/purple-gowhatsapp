...
CHARCONSTANT(GOWHATSAPP_MULTILINE_CONVERSION_OPTION, "multiline-conversion");
...
/*
 * Choices for GOWHATSAPP_MULTILINE_CONVERSION_OPTION.
 */
CHARCONSTANT(GOWHATSAPP_MULTILINE_CONVERSION_CHOICE_OFF, "off");
CHARCONSTANT(GOWHATSAPP_MULTILINE_CONVERSION_CHOICE_PIPE, "pipe");
CHARCONSTANT(GOWHATSAPP_MULTILINE_CONVERSION_CHOICE_MULTIMESSAGE, "multimessage");
